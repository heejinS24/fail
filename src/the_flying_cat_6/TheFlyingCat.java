...
public class TheFlyingCat extends JFrame {
	...
	private Image selectedImage = new ImageIcon(Main.class.getResource("../images/Level_1.png")).getImage();
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/Level_1_title.png")).getImage();
